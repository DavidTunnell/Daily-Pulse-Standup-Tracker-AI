  ...
  return (
    <div className="container mx-auto py-8 px-4">
        ...
        <ResizablePanel defaultSize={60}>
          <div className="p-6 h-full flex flex-col">
            <div className="mb-4 flex items-center border-b pb-4">
              ...
              <div>
                <h3 className="font-medium text-gray-800">Claude 3 Sonnet Analysis</h3>
      ...
      <div className="mt-6 text-center text-sm text-gray-500">
        DailyPulse AI Analysis • Responses are generated by Claude 3 Sonnet via Amazon Bedrock
      </div>
    </div>
  );
}